...
function _regenerator() {
  ...
  var u = [][n] ? t(t([][n]())) : (_regeneratorDefine2(t = {}, n, (function() {
      return this
    })), t),
    p = c.prototype = s.prototype = Object.create(u);

  function d(e) {
    return Object.setPrototypeOf ? Object.setPrototypeOf(e, c) : (e.__proto__ = c, _regeneratorDefine2(e, r, "GeneratorFunction")), e.prototype = Object.create(p), e
  }
  return l.prototype = c, _regeneratorDefine2(p, "constructor", c), _regeneratorDefine2(c, "constructor", l), l.displayName = "GeneratorFunction", _regeneratorDefine2(c, r, "GeneratorFunction"), _regeneratorDefine2(p), _regeneratorDefine2(p, r, "Generator"), _regeneratorDefine2(p, n, (function() {
    return this
...
function _toPrimitive(e, t) {
  ...
  ! function() {
    ...
    function i() {
      if (clearTimeout(t), a) {
        ...
        void 0 !== e && e.then((function() {})).catch((function(e) {})), a.addClass("hide"), a = !1
      }
    }
    var o, s = {
      ...
      play: function(e) {
        ...
        if (e.json) Lampa.Loading.start((function() {
          ...
          Lampa.Player.play(o), i.length ? (i.forEach((function(e) {
            e.title = Lampa.Utils.shortText(e.name, 50), e.icon = '<img class="size-youtube" src="' + e.picture + '" />', e.template = "selectbox_icon", e.url = function(t) {
              e.json ? l.qualitys(e.video, (function(a) {
                e.quality = a.qualitys, e.url = r(a.qualitys), a.qualitys_proxy && (e.url_reserve = r(a.qualitys_proxy)), t()
              })) : (e.url = e.video, t())
            }
          })), Lampa.Player.playlist(i)) : Lampa.Player.playlist([o]), Lampa.Player.callback((function() {
          ...
          Lampa.Player.play(a), Lampa.Player.playlist([a]), Lampa.Player.callback((function() {
            Lampa.Controller.toggle(t)
          }))
        }
      },
      fixCards: function(e) {
        e.forEach((function(e) {
          e.background_image = e.picture, e.poster = e.picture, e.img = e.picture, e.name = Lampa.Utils.capitalizeFirstLetter(e.name).replace(/\&(.*?);/g, "")
        }))
      },
      preview: function(e, n) {
        i(), t = setTimeout((function() {
          if (n.preview && Lampa.Storage.field("sisi_preview")) {
            var t, r = e.find("video"),
              i = e.find(".sisi-video-preview");
            r || (r = document.createElement("video"), (i = document.createElement("div")).addClass("sisi-video-preview"), i.style.position = "absolute", i.style.width = "100%", i.style.height = "100%", i.style.left = "0", i.style.top = "0", i.style.overflow = "hidden", i.style.borderRadius = "1em", r.style.position = "absolute", r.style.width = "100%", r.style.height = "100%", r.style.left = "0", r.style.top = "0", r.style.objectFit = "cover", i.append(r), e.find(".card__view").append(i), r.src = n.preview, r.addEventListener("ended", (function() {
              i.addClass("hide")
            })), r.load()), a = i;
            try {
              t = r.play()
    ...
    var l = new function() {
      ...
      this.menu = function(e, t) {
        ...
        AdultJS.Invoke(Lampa.Utils.addUrlComponent(e.url, "pg=" + (e.page || 1))).then((function(e) {
          e.list ? (e.results = s.fixList(e.list), e.collection = !0, e.total_pages = e.total_pages || 30, s.fixCards(e.results), delete e.list, t(e)) : a()
        })).catch((function() {
        ...
        var r = function() {
          ...
          e.onComplite = function(e) {
            ...
            AdultJS.Invoke(a.playlist_url + r + i).then((function(t) {
              clearTimeout(l), o || (t.list ? (t.title = s.sourceTitle(a.title), t.results = s.fixList(t.list), t.url = a.playlist_url, t.collection = !0, t.line_type = "none", t.card_events = {
                onMenu: s.menu,
    ...
    function u(t) {
      ...
      return n.create = function() {
        var e = this;
        this.activity.loader(!0), l.view(t, (function(t) {
          (a = t.menu) && a.forEach((function(e) {
            var t = e.title.split(":");
            e.title = t[0].trim(), t[1] && (e.subtitle = Lampa.Utils.capitalizeFirstLetter(t[1].trim().replace(/all/i, "Любой"))), e.submenu && e.submenu.forEach((function(e) {
        ...
        if (a) {
          ...
          i && Lampa.Arrays.insert(r, 0, {
            title: "Найти",
            onSelect: function() {
              $("body").addClass("ambience--enable"), Lampa.Input.edit({
                title: "Поиск",
                value: "",
                free: !0,
                nosave: !0
    ...
    window["plugin_adultjs_" + e + "_ready"] || function() {
      function t() {
        ...
        a.css({
          ...
          }), t.find(".menu__ico").css("position", "relative").append(a), t.on("hover:enter", (function() {
            Lampa.ParentalControl || (Lampa.ParentalControl = {
              ...
              l.menu((function(t) {
                ...
                })), a = a.concat(t), Lampa.Select.show({
                  title: "Сайты",
                  items: a,
                  onSelect: function(t) {
          ...
          function() {
            ...
            })), $(".head .open--search").after(n), Lampa.Listener.follow("activity", (function(r) {
              "start" == r.type && (t = r.object), clearTimeout(a), a = setTimeout((function() {
                t && t.component !== "sisi_view_" + e && (n.hide(), t = !1)
              }), 1e3), "start" == r.type && r.component == "sisi_view_" + e && (n.show(), t = r.object)
            }))
          }(), window.sisi_add_param_ready || (window.sisi_add_param_ready = !0, Lampa.SettingsApi.addComponent({
            component: "AdultJS",
      ...
      window["plugin_adultjs_" + e + "_ready"] = !0, Lampa.Component.add("sisi_" + e, c), Lampa.Component.add("sisi_view_" + e, u), window.appready ? t() : Lampa.Listener.follow("app", (function(e) {
        "ready" == e.type && t()
      }))
    }()
  }();
  var l = (e = function() {
    ...
    u = _createClass((function e(t, a, n, r, i, o, s, l, c) {
      _classCallCheck(this, e), this.name = t, this.video = a, this.picture = n, this.preview = r, this.time = i, this.quality = o, this.json = s, this.related = l, this.model = c
    })),
    p = _createClass((function e(t, a, n, r) {
      _classCallCheck(this, e), this.title = t, this.playlist_url = a, n && (this.search_on = n), r && (this.submenu = r)
    })),
    d = (t = function() {
      function e() {
        _classCallCheck(this, e)
      ...
      return _createClass(e, [{
            ...
            if (a) {
              ...
              if (n) {
                ...
                if (r || (r = c.extract(e, /src="\/\/([^"]+)"/)), r) {
                  ...
                  i || (i = a);
                  var o = null;
                  e.includes("__hd_plus __rt") ? o = "HD+" : e.includes("__hd __rtl") && (o = "HD"), t.push(new u(i, "https://" + n + ".bcvcdn.com/hls/stream_" + a + "/public-aac/stream_" + a + "/chunks.m3u8", "https://" + r, null, null, o, !1, !1, null))
                }
              }
            }
          })), t) : t
        ...
        value: function(t) {
          var a = e.host + "/",
            n = [new p("Новые", a + "new-models"), new p("Пары", a + "couples"), new p("Девушки", a + "female"), new p("Русские модели", a + "female/tags/russian"), new p("Парни", a + "male"), new p("Транссексуалы", a + "trans")],
            r = n.find((function(e) {
    ...
    h = _createClass((function e(t, a) {
      _classCallCheck(this, e), a ? (this.total_pages = 1, this.list = t.recomends) : (this.qualitys = t.qualitys, this.recomends = t.recomends)
    })),
    ...
    g = (a = function() {
      ...
      return _createClass(e, [{
        ...
        value: (t = _asyncToGenerator(_regenerator().m((function t(a) {
          ...
          return _regenerator().w((function(t) {
            for (;;) switch (t.n) {
              ...
              case 2:
                return r = new URL(a, e.host), i = r.searchParams.get("search") || "", o = r.searchParams.get("sort") || "", s = r.searchParams.get("c") || "", c = parseInt(r.searchParams.get("pg") || "1", 10), u = this.buildUrl(e.host, i, o, s, c), t.n = 3, l.Get(u);
              case 3:
                return p = t.v, t.a(2, {
                  menu: this.Menu(o, s),
        ...
        value: function(e, t, a, n, r) {
          return t ? "".concat(e, "/?k=").concat(encodeURIComponent(t), "&p=").concat(r) : n ? "".concat(e, "/c/s:").concat("top" === a ? "rating" : "uploaddate", "/").concat(n, "/").concat(r) : "top" === a ? "".concat(e, "/best/").concat(this.getLastMonth(), "/").concat(r) : "".concat(e, "/new/").concat(r)
        }
      }, {
        key: "getLastMonth",
        value: function() {
        ...
        value: function(t) {
          ...
          for (var a = t.split('<div id="video'), n = [], r = 1; r < a.length; r++) {
            ...
            if (o && o[1] && o[2] || (o = /<a href="\/(video[^"]+)"[^>]+>([^<]+)/.exec(i)) && o[1] && o[2]) {
              ...
              d = (d = d.replace(/\/[^/]+$/, "")).replace(/-[0-9]+$/, ""), n.push(new u(o[2], "".concat(e.host, "/").concat(o[1]), p, d + "_169.mp4", l || null, s || null, !0, !0, null))
            }
          }
          return n
        }
        ...
        value: function(t, a) {
          var n, r = e.host,
            ...
            o = new p("Сортировка: ".concat("like" === t ? "Понравившиеся" : "top" === t ? "Лучшие" : "Новое"), "submenu", void 0, [new p("Новое", r + "?c=".concat(a)), new p("Лучшие", r + "?sort=top&c=".concat(a))]);
          i.push(o);
          ...
          return i.push(new p("Категория: ".concat((null === (n = s.find((function(e) {
            ...
            try {
              for (o.s(); !(i = o.n()).done;) {
                ...
                if (s.tf && s.u && s.if) {
                  ...
                  l = (l = l.replace(/\/[^/]+$/, "")).replace(/-[0-9]+$/, ""), n.push(new u(s.tf, "".concat(e.host).concat(s.u), s.if, l + "_169.mp4", s.d || "", null, !0, !0, null))
                }
              }
            } catch (e) {
              o.e(e)
          ...
          return _regenerator().w((function(t) {
            for (;;) switch (t.n) {
              ...
              case 1:
                return n = t.v, t.a(2, new h(this.StreamLinks(n), a.includes("&related")));
              case 2:
                return r = new URL(a, e.host), i = r.searchParams.get("search") || "", o = parseInt(r.searchParams.get("pg") || "1", 10), s = this.buildUrl(e.host, i, o), t.n = 3, l.Get(s);
              case 3:
                return c = t.v, t.a(2, {
                  menu: this.Menu(),
    ...
    v = (r = function() {
      ...
      return _createClass(e, [{
          ...
          return _regenerator().w((function(t) {
            for (;;) switch (t.n) {
              ...
              case 1:
                return n = t.v, t.a(2, new h(this.StreamLinks(n), a.includes("&related")));
              case 2:
                return r = new URL(a, e.host), i = r.searchParams.get("search") || "", o = r.searchParams.get("sort") || "", s = parseInt(r.searchParams.get("pg") || "1", 10), c = this.buildUrl(e.host, i, o, s), t.n = 3, l.Get(c);
              case 3:
                return u = t.v, t.a(2, {
                  menu: this.Menu(o),
        ...
        value: function(e, t, a, n) {
          var r = "".concat(e, "/");
          return t ? r += "s/".concat(encodeURIComponent(t), "/").concat(n, "/") : (r += "".concat(a || "new_videos", "/").concat(n, "/"), "most_popular" === a && (r += "?p=m")), r
        }
      }, {
        key: "Playlist",
        value: function(t) {
        ...
        value: function(t) {
          var a = e.host + "/sbg";
          return [new p("Поиск", a, "search_on"), new p("Сортировка: ".concat(t || "новое"), "submenu", void 0, [new p("Новое", a), new p("Трендовое", a + "?sort=trending_videos"), new p("Популярное", a + "?sort=most_popular")])]
        }
      }, {
        key: "StreamLinks",
        value: function(e) {
      ...
      return _createClass(e, [{
        ...
        value: (a = _asyncToGenerator(_regenerator().m((function t(a) {
          ...
          return _regenerator().w((function(t) {
            for (;;) switch (t.n) {
              case 0:
                if (n = new URL(a, e.host), !a.includes("baba=")) {
                  t.n = 2;
                  break
                }
              ...
              case 2:
                return r = n.searchParams.get("sort") || "", i = parseInt(n.searchParams.get("pg") || "1", 10), o = this.buildUrl(e.host, r, i), t.n = 3, l.Get(o);
              case 3:
                return s = t.v, t.a(2, {
                  menu: this.Menu(r),
    ...
    f = (o = function() {
      ...
      return _createClass(e, [{
        ...
        value: (a = _asyncToGenerator(_regenerator().m((function t(a) {
          ...
          return _regenerator().w((function(t) {
            for (;;) switch (t.n) {
              ...
              case 2:
                return n = new URL(a, e.host), r = n.searchParams.get("search") || "", i = n.searchParams.get("sort") || "", o = n.searchParams.get("c") || "", s = parseInt(n.searchParams.get("pg") || "1", 10), c = this.buildUrl(e.host, r, i, o, s), t.n = 3, l.Get(c);
              case 3:
                return u = t.v, t.a(2, {
        ...
        value: function(e, t, a, n, r) {
          var i = "".concat(e, "/");
          return t ? (i += "search/".concat(encodeURIComponent(t), "/"), r > 1 && (i += "".concat(r, "/")), a && (i += "".concat(a, "/"))) : n ? (i += "cat/".concat(n, "/"), r > 1 && (i += "".concat(r, "/"))) : (r > 1 && (i += "".concat(r, "/")), a && (i += "".concat(a, "/"))), i
        }
      }, {
        key: "Playlist",
        value: function(t) {
          if (!t) return [];
          var a = t;
          a.includes('class="toptopbelinset"') && (a = a.split('class="toptopbelinset"')[1]), a.includes('class="relatedtext"') && (a = a.split('class="relatedtext"')[1]);
        ...
        value: function(t, a, n) {
          ...
          return o.push(new p("Категория: ".concat((null === (r = s.find((function(e) {
          ...
          return _regenerator().w((function(e) {
            for (;;) switch (e.n) {
              ...
              case 2:
                ...
                return e.a(2, new m({}, []));
              case 3:
                if (r = c.extract(n, /vid ?= ?'([^']+)'/), i = c.extract(n, /hash ?= ?'([^']+)'/), r && i) {
                  e.n = 4;
                  break
                }
                return e.a(2, new m({}, []));
              case 4:
                return o = "".concat(t, "/xhr/video/").concat(r, "?hash=").concat(this.convertHash(i), "&domain=").concat(t.replace(/^https?:\/\//, ""), "&fallback=false&embed=false&supportedFormats=dash,mp4&_=").concat(Math.floor(Date.now() / 1e3)), e.n = 5, l.Get(o);
              case 5:
                if (s = e.v) {
                  e.n = 6;
                  break
  ...
  var S = (s = function() {
      return _createClass((function e(t) {
        ...
        value: function(e, t, a, n) {
          ...
          if (null !== (i = e.menu) && void 0 !== i && i.route)
            ...
            var d;
            s = 1 === t && null != (null === (d = e.list) || void 0 === d ? void 0 : d.firstpage) ? e.list.firstpage : e.list ? e.list.uri : "{host}"
        ...
        key: "buildMenu",
        value: function(e, t, a) {
          var n, r, i, o = arguments.length > 3 && void 0 !== arguments[3] && arguments[3],
            s = arguments.length > 4 ? arguments[4] : void 0,
            l = [];
          if (o || l.push(new p("Поиск", "nexthub://".concat(e.displayname, "?mode=search"), "search_on")), o && null !== (n = e.view) && void 0 !== n && n.related && s) {
          ...
          if (null !== (r = e.menu) && void 0 !== r && r.sort) {
            for (var m = [], g = 0, y = Object.entries(e.menu.sort); g < y.length; g++) {
              var v, b = _slicedToArray(y[g], 2),
                f = b[0],
                k = (b[1], "nexthub://".concat(e.displayname, "?mode=list&sort=").concat(encodeURIComponent(f)));
              a && null !== (v = e.menu) && void 0 !== v && null !== (v = v.route) && void 0 !== v && v.catsort && (k += "&cat=".concat(encodeURIComponent(a))), m.push(new p(f, k))
            }
        ...
        value: function(e, t) {
          ...
          try {
            for (o.s(); !(a = o.n()).done;) {
              ...
              if (v && ((v = v.replace(/&amp;/g, "&").replace(/\\/g, "")).startsWith("../") ? v = "".concat(t.host, "/").concat(v.replace("../", "")) : v.startsWith("//") ? v = "https:".concat(v) : v.startsWith("/") ? v = t.host + v : v.startsWith("http") || (v = "".concat(t.host, "/").concat(v))), y && g && v) {
                ...
                if (n.model) {
                  ...
                  if (_ && S && n.model.href) {
                    ...
                    P && z && (w = {
                      uri: "nexthub://".concat(t.displayname.toLowerCase(), "?mode=model&model=").concat(encodeURIComponent(z)),
                      name: P
                    })
                  }
                }
        ...
        value: (t = _asyncToGenerator(_regenerator().m((function e(t, a) {
          ...
          return _regenerator().w((function(e) {
            for (;;) switch (e.n) {
              case 0:
                if (s = {}, null === (n = a.view) || void 0 === n || null === (n = n.iframe) || void 0 === n || !n.pattern) {
                  e.n = 2;
                  break
                }
                if (c = new RegExp(a.view.iframe.pattern, "g"), !(u = c.exec(t)) || !u[1]) {
                  e.n = 2;
                  break
                }
              ...
              case 1:
                t = e.v;
              case 2:
                if (null === (r = a.view) || void 0 === r || !r.eval) {
                  e.n = 3;
                  break
                }
                try {
                ...
                break;
              case 3:
                if (null === (i = a.view) || void 0 === i || !i.nodeFile) {
                  e.n = 4;
                  break
                }
                y = _(t), (v = x(y, a.view.nodeFile.node)) && (b = C(v, a.view.nodeFile.attribute)) && (s.auto = b.replace(/&amp;/g, "&").replace(/\\/g, "")), e.n = 15;
                break;
              case 4:
                if (null !== (f = a.view) && void 0 !== f && null !== (f = f.regexMatch) && void 0 !== f && f.pattern) {
                  e.n = 5;
                  break
                }
              ...
              case 7:
                ...
                P = S.value, (z = a.view.regexMatch.pattern).includes("{value}") && (z = z.replace("{value}", P)), L = new RegExp(z, "g"), j = void 0, M = !1;
              case 8:
                if (!(j = L.exec(t))) {
                  e.n = 10;
                  break
                ...
                return e.a(3, 8);
              case 9:
                A = T, a.view.regexMatch.format && (A = a.view.regexMatch.format.replace("{host}", a.host).replace("{value}", T)), s.auto = A.replace(/&amp;/g, "&").replace(/\\/g, ""), M = !0, e.n = 8;
                break;
              case 10:
                if (!M) {
                  e.n = 11;
              ...
              case 15:
                return I = [], null !== (o = a.view) && void 0 !== o && o.related && (B = _(t), I.push.apply(I, _toConsumableArray(this.toPlaylist(B, a)))), e.a(2, new m(s, I))
            }
          }), e, this, [[6, 13, 14, 15]])
        }))), function(e, a) {
          return t.apply(this, arguments)
        ...
        value: (e = _asyncToGenerator(_regenerator().m((function e(t) {
          ...
          return _regenerator().w((function(e) {
            for (;;) switch (e.n) {
              case 0:
                if (a = new URL(t), n = a.hostname || a.pathname.replace(/^\//, "") || t.replace("nexthub://", "").split("?")[0], r = this.cfgs.find((function(e) {
              ...
              case 1:
                if (console.log("NextHub: Invoke ".concat(t)), "view" !== (i = a.searchParams.get("mode") || "list") && "related" !== i) {
                  e.n = 5;
                  break
                }
              ...
              case 2:
                return s = decodeURIComponent(o), c = s.replace("&related?pg=1", ""), e.n = 3, l.Get(c, void 0, r.charset);
              case 3:
              ...
              case 6:
                return m = Number(a.searchParams.get("pg") || "1"), g = this.buildModelUrl(r, d, m), e.n = 7, l.Get(g, void 0, r.charset);
              case 7:
                return y = e.v, v = _(y), e.a(2, {
              ...
              case 8:
                ...
                return b = a.searchParams.getAll("search"), f = b.find((function(e) {
                  return "" !== e.trim()
                })) || "", k = Number(a.searchParams.get("pg") || "1"), w = this.buildSearchUrl(r, f, k), e.n = 9, l.Get(w, void 0, r.charset);
              case 9:
                return x = e.v, C = _(x), e.a(2, {
                  menu: this.buildMenu(r, void 0, void 0, !1),
                  list: this.toPlaylist(C, r)
                });
              case 10:
                return S = a.searchParams.get("sort") || "", P = a.searchParams.get("cat") || "", z = Number(a.searchParams.get("pg") || "1"), L = this.buildListUrl(r, z, S, P), e.n = 11, l.Get(L, void 0, r.charset);
              case 11:
                return j = e.v, M = _(j), e.a(2, {
    ...
    P = [{
      ...
      search: {
        uri: "search/{search}/latest-updates/{page}/"
      },
      contentParse: {
